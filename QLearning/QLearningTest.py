...
np.random.seed(2)  # reproducible 产生一组随机数列


N_STATES = 6   # the length of the 1 dimensional world 一维世界的长度
ACTIONS = ['left', 'right']     # available actions 可选用的方法
